...
<div className="home-content">
  <div className="content-container">
    ...
    We’re striving to launch FOSSBilling 1.0.0 and we’re eager to have you join our journey! Keep in mind, FOSSBilling is in a dynamic pre-production stage, so some prowess or willingness to learn will help you make the most out of it.<br /><br />
    Before diving in, please review the release notes for any updates and consider some familiarity with PHP and software development to be advantageous. It’ll allow you to contribute and navigate through any hiccups you might face.<br /><br />
    <b>Let's Make It Happen Together! 🌟</b><br />
  ...
  <div className="content-container">
    <h3 classname="headline">Ready to Dive In? 🚀</h3>
    ...
    <p className="subtitle">[Donate](https://opencollective.com/FOSSBilling) now and support your favorite open source project!</p>
  </div>
</div>
