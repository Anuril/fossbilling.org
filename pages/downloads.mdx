...
<div className="home-content">
  <div className="content-container">
    ...
    <p>If you find value in what we are building and would like to support us, please consider [becoming a sponsor](https://opencollective.com/FOSSBilling). <br /> Every bit helps, and we are grateful for your support.</p>
  </div>
