...
<div className="home-content">
  <div className="content-container">
    ...
    <p className="subtitle">Welcome to the FOSSBilling Download Page! 🎉 <br />    We're excited to have you here! We are on the journey towards the release of version 1.0.0, and we're working hard to make FOSSBilling ready for production use.<br /><br />Please bear in mind a few key points as you consider downloading:</p>
    ...
    <h3 className="headlineSmall">Let's Grow Together! 🌱</h3>
  ...
  <div className="content-container">
    <h3 classname="headlineSmall">Ready to Dive In? 🚀</h3>
