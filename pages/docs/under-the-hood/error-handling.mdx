...
| 6801 - 6850 | Proxmox Extension Error Codes |
...
| Code | Description |
| ---- | ----------- |
| 6001 | Generic knowledge base extension errors |
...
| Code | Description |
| ---- | ----------- |
| 6301 | Generic Paid Support extension errors |

### Mass Mail Extension Error Codes

| Code | Description |
| ---- | ----------- |
| 6751 | Generic Mass Mail extension errors |
| 6752 | Mass Mail extension configuration  |


## Old Legacy Error Codes currently in Use (Will be replaced with 0.6.0)
